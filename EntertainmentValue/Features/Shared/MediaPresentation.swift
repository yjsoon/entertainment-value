...
extension MediaKind {
    ...
    var accentColor: Color {
        switch self {
        case .book, .comic: EntertainmentValueTheme.coral
        case .movie, .tvShow: EntertainmentValueTheme.sky
        case .game: EntertainmentValueTheme.sage
        case .podcast: .purple
        case .unknown: EntertainmentValueTheme.secondaryInk
        }
    }
...
extension ConsumptionStatus {
    ...
    var color: Color {
        switch self {
        case .planned: EntertainmentValueTheme.secondaryInk
        case .inProgress: EntertainmentValueTheme.coral
        case .paused: .orange
        case .completed: EntertainmentValueTheme.sage
