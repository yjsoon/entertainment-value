...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section("About") {
                Link("Entertainment Value on GitHub", destination: URL(string: "https://github.com/yjsoon/entertainment-value")!)
        ...
        Button {
            ...
            LabeledContent {
                Label(statusText, systemImage: statusSymbol)
                    .foregroundStyle(status.isUsable ? EntertainmentValueTheme.sage : EntertainmentValueTheme.coral)
            } label: {
