...
extension UTType {
    nonisolated static let entertainmentValueBackup = UTType(
        exportedAs: "com.yjsoon.whatfun.backup",
        conformingTo: .json
    )

    nonisolated static let entertainmentValueArchive = UTType(
...
struct FullBackupDocument: FileDocument {
    static var readableContentTypes: [UTType] { [.entertainmentValueBackup, .json] }
...
struct PortableArchiveDocument: FileDocument {
    static var readableContentTypes: [UTType] { [.entertainmentValueArchive, .package, .folder] }
