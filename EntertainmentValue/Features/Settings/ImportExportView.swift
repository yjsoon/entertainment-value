...
struct ImportExportView: View {
    ...
    var body: some View {
        ...
        .fileExporter(
            ...
            contentType: .entertainmentValueArchive,
        ...
        .fileExporter(
            ...
            contentType: .entertainmentValueBackup,
        ...
        .fileImporter(
            ...
            allowedContentTypes: [.entertainmentValueArchive, .package, .folder],
            allowsMultipleSelection: false,
            onCompletion: receivePortableArchive
        )
        .fileImporter(
            isPresented: $presentsFullImporter,
            allowedContentTypes: [.entertainmentValueBackup, .json],
            allowsMultipleSelection: false,
