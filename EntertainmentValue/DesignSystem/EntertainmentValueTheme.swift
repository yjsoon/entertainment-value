...
struct ArchiveBackground: ViewModifier {
  func body(content: Content) -> some View {
    content
      ...
      .background(EntertainmentValueTheme.background.ignoresSafeArea())
      .tint(EntertainmentValueTheme.coral)
  }
}
...
nonisolated struct CoverShape: InsettableShape {
