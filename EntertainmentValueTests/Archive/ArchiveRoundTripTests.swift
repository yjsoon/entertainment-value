...
@Suite("EntertainmentValue archive formats")
struct ArchiveRoundTripTests {
    ...
    func fullBackupRoundTrip() throws {
        ...
        let envelope = FullFidelityArchiveEnvelope(
            ...
            generator: "EntertainmentValueTests/1",
    ...
    func directoryStoreRoundTrip() async throws {
        ...
        let root = FileManager.default.temporaryDirectory
            .appending(path: "EntertainmentValueArchiveTests-\(UUID().uuidString)", directoryHint: .isDirectory)
